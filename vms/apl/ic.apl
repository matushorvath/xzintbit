...
add:3 setp ((getp 1 I R)+(getp 2 I R))⋄I←I+4⋄exec⋄→0
mul:3 setp ((getp 1 I R)×(getp 2 I R))⋄I←I+4⋄exec⋄→0
...
jmpf:I←I+3⋄exec⋄→0
lt:3 setp ((getp 1 I R)<(getp 2 I R))⋄I←I+4⋄exec⋄→0
eq:3 setp ((getp 1 I R)=(getp 2 I R))⋄I←I+4⋄exec⋄→0
